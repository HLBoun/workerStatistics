...
int main()
{
  ...
  std::cout << "Employee Title: " << janine.getJobTitle() << "\n";
  ...
  TeamLeader harry("Harry", 20, "Jan 5th", 1, 20.25, 1000, 10, 10);
  std::cout << "Employee Name: " << harry.getEmployeeName() << "\n";
  std::cout << "Employee ID#: " << harry.getEmployeeNumber() << "\n";
  std::cout << "Employee Title: " << harry.getJobTitle() << "\n";
  ...
  std::cout << "Employee Monthly Bonus: $" << harry.getMonthlyBonus() << "\n";
